...
#include <sched.h>      //Lib for using a specific scheduling policy
...
int main(int argc, char* argv[]) {
  ...
  //variables used in for loops in forking
  int j, k;
  int status; //variable for wait

  //Changing schedule policy, set to 5th argument
  int policy;
